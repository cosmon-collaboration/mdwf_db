...
#SBATCH -o /global/u2/s/smithwya/mdwf_db/TUNING/b6.0/b2.5Ls12/mc0.6/ms0.04/ml0.005/L24/T48/mres/jlog/%j.log

cd "/global/u2/s/smithwya/mdwf_db/TUNING/b6.0/b2.5Ls12/mc0.6/ms0.04/ml0.005/L24/T48/mres"
mkdir -p DATA
...
mdwf_db update -e 1 -o WIT_MRES -s RUNNING \
  -p "slurm_job_id=$SLURM_JOB_ID config_start=0 config_end=12 config_increment=1 wit_input=/global/u2/s/smithwya/mdwf_db/TUNING/b6.0/b2.5Ls12/mc0.6/ms0.04/ml0.005/L24/T48/mres/DWF_mres.in workdir=/global/u2/s/smithwya/mdwf_db/TUNING/b6.0/b2.5Ls12/mc0.6/ms0.04/ml0.005/L24/T48/mres nodes=1 ranks=4" \
  || true
...
WIT_INPUT="/global/u2/s/smithwya/mdwf_db/TUNING/b6.0/b2.5Ls12/mc0.6/ms0.04/ml0.005/L24/T48/mres/DWF_mres.in"

echo "Running mres range 0-12 step 1"
