...
#SBATCH -o /global/u2/s/smithwya/mdwf_db/TUNING/b6.0/b2.5Ls12/mc0.6/ms0.04/ml0.005/L24/T48/cnfg_HYP5/jlog/%j.log
#SBATCH -e /global/u2/s/smithwya/mdwf_db/TUNING/b6.0/b2.5Ls12/mc0.6/ms0.04/ml0.005/L24/T48/cnfg_HYP5/jlog/%j.err

set -euo pipefail

cd "/global/u2/s/smithwya/mdwf_db/TUNING/b6.0/b2.5Ls12/mc0.6/ms0.04/ml0.005/L24/T48/cnfg_HYP5"
mkdir -p jlog
...
for((cnf=0; cnf<12; cnf+=$mxcnf)); do
    for((i=0;i<NSIM;i++)); do
        ...
        out_cfg="/global/u2/s/smithwya/mdwf_db/TUNING/b6.0/b2.5Ls12/mc0.6/ms0.04/ml0.005/L24/T48/cnfg_HYP5/u_HYP5n${c}"
        "$GLU" -i "/global/u2/s/smithwya/mdwf_db/TUNING/b6.0/b2.5Ls12/mc0.6/ms0.04/ml0.005/L24/T48/cnfg_HYP5/glu_smear.in" -c "$in_cfg" -o "$out_cfg" &
    done
    wait
done
