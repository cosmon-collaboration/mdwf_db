...
from MDWFutils.jobs.mres import generate_mres_sbatch
...
def register(subparsers):
    p = subparsers.add_parser(
        ...
        description="""
Generate SLURM script for mres measurements using WIT.
