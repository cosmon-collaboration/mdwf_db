...
class GluContextBuilder(ContextBuilder):
    ...
    input_params_schema = [
        ...
        ContextParam("CONFNO", str, default="24", storable=False, help="Configuration number"),
        ...
        ContextParam("DIM_0", str, storable=False, help="Lattice dimension 0 (auto from ensemble)"),
        ContextParam("DIM_1", str, storable=False, help="Lattice dimension 1 (auto from ensemble)"),
        ContextParam("DIM_2", str, storable=False, help="Lattice dimension 2 (auto from ensemble)"),
        ContextParam("DIM_3", str, storable=False, help="Lattice dimension 3 (auto from ensemble)"),
