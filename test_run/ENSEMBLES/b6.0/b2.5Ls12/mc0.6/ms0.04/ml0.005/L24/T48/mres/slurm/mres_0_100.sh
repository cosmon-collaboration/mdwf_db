...
mdwf_db update -e 1 -o WIT_MRES -s RUNNING \
  -p "slurm_job_id=$SLURM_JOB_ID config_start=0 config_end=100 config_increment=4 wit_input=/global/u2/s/smithwya/test_run/TUNING/b6.0/b2.5Ls12/mc0.6/ms0.04/ml0.005/L24/T48/mres/DWF_mres.in workdir=/global/u2/s/smithwya/test_run/TUNING/b6.0/b2.5Ls12/mc0.6/ms0.04/ml0.005/L24/T48/mres nodes=1 ranks=4" \
  || true
